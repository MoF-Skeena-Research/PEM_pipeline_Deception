...
# # vector (aoi, roads and start points)
# 
# in_dir = read_fid()$dir_1010_vector$path_abs
# aoi_file = file.path(in_dir, "aoi_snapped.gpkg" )
# 
# out_dir <- read_fid()$dir_201010_inputs$path_abs
# 
# 
# aoils <- snap_aoi(aoi_file, method = "expand", buffer = 1000, write_output = FALSE)
# 
# sf::st_write(aoils, file.path(out_dir, "aoi_snapped_ls.gpkg"), append = FALSE)
# 
# 
# 
