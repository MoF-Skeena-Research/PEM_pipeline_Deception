...
bc_outline <- sf::st_read("C:/Users/ccarmour.stu/Documents/GitHub/PEMtestr/summary_report/data/bc_outline.gpkg", quiet = TRUE)
...
dem <- terra::rast("C:/Users/ccarmour.stu/OneDrive - Government of BC/PEM/AOIs/DateCreek_AOI/0_raw_inputs/dem/lidar/1m_DTM_mosaic.tif")
...
covars.df <- list.files("C:/Users/ccarmour.stu/OneDrive - Government of BC/PEM/AOIs/DateCreek_AOI/1_map_inputs/covariates/25m", pattern = ".tif$", full.names = TRUE) %>%
  terra::rast() %>%
  terra::values() %>%
  data.frame()
